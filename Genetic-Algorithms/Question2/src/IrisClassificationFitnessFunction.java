...
public class IrisClassificationFitnessFunction extends FitnessFunction {
	...
	public static final double[][] data = new double[][] {
		...
		{4.8,3.0,1.4,0.3}, {5.1,3.8,1.6,0.2}, {4.6,3.2,1.4,0.2}, {5.3,3.7,1.5,0.2}, {5.0,3.3,1.4,0.2},  //50
		...
		{5.7,3.0,4.2,1.2}, {5.7,2.9,4.2,1.3}, {6.2,2.9,4.3,1.3}, {5.1,2.5,3.0,1.1}, {5.7,2.8,4.1,1.3},  //100
